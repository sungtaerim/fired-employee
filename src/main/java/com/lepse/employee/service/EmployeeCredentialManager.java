package com.lepse.employee.service;
...
public class EmployeeCredentialManager implements CredentialManager {
    ...
    public EmployeeCredentialManager(String name, String password, String tcServer) {
        this.name = name;
